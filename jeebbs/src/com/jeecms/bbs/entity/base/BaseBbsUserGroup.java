...
/**
 * This is an object that contains data related to the BBS_USER_GROUP table.
...
public abstract class BaseBbsUserGroup  implements Serializable {
	 ...
	 * @param type the GROUP_TYPE value
	 */
	 ...
	 * @param imgPath the GROUP_IMG value
	 */
	 ...
	 * @param point the GROUP_POINT value
	 */
	 ...
	 * @param gradeNum the GRADE_NUM value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsUserGroup)) return false;
		else {
			com.jeecms.bbs.entity.BbsUserGroup bbsUserGroup = (com.jeecms.bbs.entity.BbsUserGroup) obj;
			if (null == this.getId() || null == bbsUserGroup.getId()) return false;
			else return (this.getId().equals(bbsUserGroup.getId()));
		}
	}
