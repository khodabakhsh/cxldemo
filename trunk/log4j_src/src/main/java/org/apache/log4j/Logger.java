...
public class Logger extends Category {
	...
	/**
	 * Log a message object with the {@link Level#FINE FINE} level which is just an alias for the {@link Level#DEBUG
	 * DEBUG} level.
	 * 
	 * <p>
	...
	/**
	 * Log a message object with the <code>FINE</code> level including the stack trace of the {@link Throwable}
	...
	/**
	 * Log a message object with the <code>TRACE</code> level including the stack trace of the {@link Throwable}
	 * <code>t</code> passed as parameter.
	 * 
	 * <p>
