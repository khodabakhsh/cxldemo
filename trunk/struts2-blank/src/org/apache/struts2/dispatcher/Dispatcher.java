...
public class Dispatcher {
    ...
    private Container init_PreloadConfiguration() {
    	//configuration == null的时候getConfiguration实例化一个DefaultConfiguration返回，并会reloadContainer
    ...
    public void init() {
        ...
        try {
        	...
        	//这个@DefaultPropertiesProvider 在注册register的时候读取org/apache/struts2/default.properties文件，
//        	     加载其中的配置。
            init_DefaultProperties(); 
            
//          在configurationManager加入了strut默认3个配置文件作configurationManager的containerProviders
          //这个@StrutsXmlConfigurationProvider 在注册register的时候读取strut默认3个配置文件,
//   	          加载其中的配置。
