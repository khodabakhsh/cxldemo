...
/**
 * This is an object that contains data related to the BBS_FORUM table.
...
public abstract class BaseBbsForum  implements Serializable {
	...
	public BaseBbsForum (
		...
		java.lang.Integer topicLockLimit,
		java.lang.Integer priority,
		java.lang.Integer topicTotal,
		java.lang.Integer postTotal,
		java.lang.Integer postToday,
		java.lang.Integer pointTopic,
		java.lang.Integer pointReply,
	 ...
	 * @param forumRule the FORUM_RULE value
	 */
	 ...
	 * @param topicLockLimit the TOPIC_LOCK_LIMIT value
	 */
	 ...
	 * @param topicTotal the TOPIC_TOTAL value
	 */
	 ...
	 * @param postTotal the POST_TOTAL value
	 */
	 ...
	 * @param postToday the POST_TODAY value
	 */
	 ...
	 * @param pointTopic the POINT_TOPIC value
	 */
	 ...
	 * @param pointReply the POINT_REPLY value
	 */
	 ...
	 * @param pointPrime the POINT_PRIME value
	 */
	 ...
	 * @param groupViews the group_views value
	 */
	 ...
	 * @param groupTopics the group_topics value
	 */
	 ...
	 * @param groupReplies the group_replies value
	 */
	 ...
	 * @param lastPost the POST_ID value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsForum)) return false;
		else {
			com.jeecms.bbs.entity.BbsForum bbsForum = (com.jeecms.bbs.entity.BbsForum) obj;
			if (null == this.getId() || null == bbsForum.getId()) return false;
			else return (this.getId().equals(bbsForum.getId()));
		}
	}
