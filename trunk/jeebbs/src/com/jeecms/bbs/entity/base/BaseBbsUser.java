...
/**
 * This is an object that contains data related to the jb_user table.
...
public abstract class BaseBbsUser  implements Serializable {
	 ...
	 * @param uploadToday the UPLOAD_TODAY value
	 */
	 ...
	 * @param avatarType the AVATAR_TYPE value
	 */
	 ...
	 * @param primeCount the PRIME_COUNT value
	 */
	 ...
	 * @param lastPostTime the LAST_POST_TIME value
	 */
	 ...
	 * @param prohibitPost the PROHIBIT_POST value
	 */
	 ...
	 * @param prohibitTime the PROHIBIT_TIME value
	 */
	 ...
	 * @param gradeToday the GRADE_TODAY value
	 */
	 ...
	 */
	public void setUserExtSet (java.util.Set<com.jeecms.bbs.entity.BbsUserExt> userExtSet) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsUser)) return false;
		else {
