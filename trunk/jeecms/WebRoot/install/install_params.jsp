  ...
  <tr>
    <td height="400" align="center" bgcolor="#F0F8FD"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left"><input name="dbName" type="text" class="input" id="dbName" value="jeecms_3_1_1_final" /></td>
				<td align="left">&nbsp;</td>
      </tr>
      <tr>
...
<input type="hidden" name="dbFileName" value="/install/db/jeecms-db-3.1.1-final.sql"/>
<input type="hidden" name="initFileName" value="/install/db/jeecms-init-3.1.1-final.sql"/>
</form>
</body>
</html>
