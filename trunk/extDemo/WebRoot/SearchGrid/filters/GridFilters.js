...
Ext.extend(Ext.ux.grid.GridFilters, Ext.util.Observable, {
			 ...
			 * 
			 * @return {Ext.ux.grid.filter.Filter} The existing or newly created
			 *         filter object.
			 */
			...
			getFilterData : function() {
				var filters = [], fields = this.grid.getStore().fields;
...
//			},
		...
		// 重写生成query的安符串，
			...
			getFilterClass : function(type) {
				return Ext.ux.grid.filter[type.substr(0, 1).toUpperCase()
