...
public class OptionConverter {
	 ...
	 * 
	 * <p>
	 * If any error occurs while converting the value to a level, the <code>defaultValue</code> parameter, which may be
	 ...
	 * @param clazz The class name, of the log4j configurator which will parse the <code>inputStream</code>. This must
	 * be a subclass of {@link Configurator}, or null. If this value is null then a default configurator of
	 ...
	 * This must be a subclass of {@link Configurator}, or null. If this value is null then a default configurator of
	 * {@link PropertyConfigurator} is used, unless the filename pointed to by <code>url</code> ends in '.xml', in which
	 * case {@link org.apache.log4j.xml.DOMConfigurator} is used.
	 * @param hierarchy The {@link org.apache.log4j.Hierarchy} to act on.
	 * @since 1.1.4
	 */
