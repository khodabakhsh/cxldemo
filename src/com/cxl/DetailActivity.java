...
public class DetailActivity extends Activity implements UpdatePointsNotifier {
	...
	public static final int Read_Requre_Point_Page_Index = 3000;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!canView(Integer.parseInt(itemIndex))) {
			...
			showGetPointDialog("继续阅读 【"
					+ ListManager.AllList.get(Read_Requre_Point_Page_Index
							- Start_Page_Index) + "】 之后的内容哦!");
			itemIndex = "01";
		}
...
//		textView.setText(getFileContent(DetailActivity.this, itemIndex));
	...
	private void initRequrePointPreference() {
		hasEnoughAdPointPreferenceValue = PreferenceUtil
				.getHasEnoughAdPoint(DetailActivity.this);
		hasEnoughReadPointPreferenceValue = PreferenceUtil
				.getHasEnoughReadPoint(DetailActivity.this);
	}
