...
class Formatter {
	...
	/*
	 * Return the input value rounded to one decimal place. If after rounding the string ends in the (locale-specific)
	 * decimal point followed by a zero then trim that off as well.
	 */
