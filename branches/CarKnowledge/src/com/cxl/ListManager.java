...
public class ListManager {
	...
	static {
		...
		First_Menu_List.add("第一篇、驾驶");
		First_Menu_List.add("第二篇、保养");
		First_Menu_List.add("第三篇、维修");
		First_Menu_List.add("第四篇、技术知识");
		First_Menu_List.add("第五篇、保险");
		First_Menu_List.add("第六篇、其他补充资料");
