...
public class MainActivity extends Activity implements UpdatePointsNotifier {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		herb = (TextView) findViewById(R.id.herb);

		HerbUtil herbUtil = new HerbUtil();
		Map<String, String> queryParams = new HashMap<String, String>();
//		try {
			queryParams.put("B1", "查询");
			queryParams.put("title", "茯苓");
//		} catch (UnsupportedEncodingException e1) {
//			e1.printStackTrace();
//		};
//		System.out.println();
			String text = herbUtil.getHerb(herbUtil.getDocumentContentByPost(HerbUtil.getHerbUrl, queryParams)).toString();
		herb.setText(text);
	...
	protected void onListItemClick(ListView arg0, View arg1, int pos, long id) {
		...
		bundle.putString("id", String.valueOf(pos + 1));
