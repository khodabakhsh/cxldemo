	...
	public void onCreate(Bundle savedInstanceState) {
		...
		queryButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				String firstName = ((Map<String, String>) firstConstellation.getSelectedItem()).get("name");
				String secondName = ((Map<String, String>) secondConstellation.getSelectedItem()).get("name");
				String id = ConstellationNameIdMap.get(firstName + "和" + secondName);
