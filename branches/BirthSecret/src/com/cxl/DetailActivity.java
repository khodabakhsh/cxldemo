	...
	public void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				String yue = bundle.getString("yue");
				String ri = bundle.getString("ri");
				mWebView = (WebView) findViewById(R.id.myWebView);
				mWebView.loadDataWithBaseURL(ConstellationPairUtil.getBirthSecretDetailUrl,
						new ConstellationPairUtil().getConstellationPairDetail(yue, ri), "text/html",
						ConstellationPairUtil.UTF8, "");
